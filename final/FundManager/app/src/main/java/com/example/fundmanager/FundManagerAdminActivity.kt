...
class FundManagerAdminActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityFundManagerAdminBinding.inflate(layoutInflater)
        ...
        adapter.setOnKotlinItemClickListener(object : FundAdapter.IKotlinItemClickListener {
            override fun onItemClickListener(position: Int) {
                ...
                val intent = Intent(this@FundManagerAdminActivity,FundInnerActivity::class.java)
...
//            getAllFundByJson(get_all_fund_json_url)
...
//        }
        ...
        binding.btnPersonInfo.setOnClickListener(){
            val intent = Intent(this@FundManagerAdminActivity,PersonInfoActivity::class.java)
//            startActivityForResult(intent,5)
        }
        //添加基金按钮
        binding.btnAddFund.setOnClickListener(){
//            addFundByOkHttp(binding, add_fund_url, "中欧盛世成长混合","3.0316","5.87亿","9年237天","2.29%","3.46%","18.35%","14.41%","200")
//            addFundByOkHttp(binding, add_fund_url, "金信民长混合A","2.3682","1.00亿","1年184天","0.09%","3.50%","18.30%","104.65%","100")
//            addFundByOkHttp(binding, add_fund_url, "中欧永裕混合A","2.1550","5.11亿","6年170天","2.28%","3.44%","18.27%","13.50%","300")
            val intent = Intent(this@FundManagerAdminActivity,FundAddActivity::class.java)
             startActivity(intent)
//            startActivityForResult(intent,2)
//            Toast.makeText(this, "添加成功", Toast.LENGTH_LONG).show()
        }
        //修改基金
        binding.btnUpdateFund.setOnClickListener(){
            val intent = Intent(this@FundManagerAdminActivity,FundUpdateActivity::class.java)
            startActivity(intent)
...
//            Toast.makeText(this, "更新成功", Toast.LENGTH_LONG).show()
        ...
        binding.btnDeleteFund.setOnClickListener(){
            val intent = Intent(this@FundManagerAdminActivity,FundDeleteActivity::class.java)
            startActivity(intent)
...
//            5 -> if(resultCode == Activity.RESULT_OK){}
    ...
    // 通过json得到基金数据
    private fun getAllFundByJson(url:String){
        thread {
            try {
