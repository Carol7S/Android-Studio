...
import com.example.fundmanager.databinding.ActivityFundUpdateBinding
...
class FundUpdateActivity : AppCompatActivity() {
    private val server_ip = "192.168.1.100"
    private val add_fund_url = "http://${server_ip}:8080/AndroidServer_Web_exploded/update_Fund.jsp"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fund_update)
        val binding = ActivityFundUpdateBinding.inflate(layoutInflater)
...
//            setResult(Activity.RESULT_OK,intent)
    ...
    private fun addFundByOkHttp(url:String, name:String, value:String, size:String, time:String, DailyIncrease:String, WeeklyIncrease:String, MonthlyIncrease:String, YearlyIncrease:String, holdNum:String){
        thread {
            try {
